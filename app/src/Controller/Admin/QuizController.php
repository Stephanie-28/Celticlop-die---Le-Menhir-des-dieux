...
final class QuizController extends AbstractController
{
    ...
    public function index(QuizRepository $repository): Response { return $this->render('admin/content/index.html.twig', ['items' => $repository->findBy([], ['createdAt' => 'DESC']), 'title' => 'Quiz', 'description' => 'Administrer les parcours Quiz existants. Les questions liées restent protégées par leurs relations.', 'userStory' => 'US51 — Gérer le quiz', 'newRoute' => 'app_admin_quiz_new', 'newLabel' => 'Ajouter un Quiz', 'editRoute' => 'app_admin_quiz_edit', 'deleteRoute' => 'app_admin_quiz_delete', 'deleteTokenPrefix' => 'delete-quiz-', 'displayProperty' => 'title', 'subtitleProperty' => 'description', 'countProperty' => 'questions']); }
